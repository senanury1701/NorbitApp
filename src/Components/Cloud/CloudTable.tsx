...
import { fetchCloud } from '../../slices/thunks';
...
import CloudEditModal from '../Cloud/CloudEditModal'; 
import CloudAddModal from '../Cloud/CloudAddModal';
import CloudViewModal from '../Cloud/CloudViewModal';
import { useAppDispatch } from '../hooks';
import { deleteCloud } from '../../slices/cloud/thunks';
...
const CloudTable = ({
  ...
  const { count } = useSelector((state:any) => state.cloud);
    ...
    <Fragment>
      ...
      <Modal isOpen={modalEditOpen} toggle={toggleEdit} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody className='z-2'>
          <CloudEditModal rowData={selectedRowData} toggleEdit={toggleEdit} />
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalAddOpen} toggle={toggleAdd} centered tabIndex={-1}>
        ...
        <ModalBody>
          <div>
            <CloudAddModal toggleAdd={toggleAdd} pageZero={pageZero}/>
          </div>
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalViewOpen} toggle={toggleView} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody style={{ minHeight: '500px' }}>
          <CloudViewModal rowId={selectedRowId}/>
        </ModalBody>
        <ModalFooter>
