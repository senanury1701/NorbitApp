...
import DataSheetEditModal from '../DataSheet/DataSheetEditModal'; 
import DataSheetAddModal from '../DataSheet/DataSheetAddModal';
import DataSheetViewModal from '../DataSheet/DataSheetViewModal';
import { useAppDispatch } from '../hooks';
import { deleteDataSheet } from '../../slices/datasheet/thunks';
...
const DataSheetTable = ({
  ...
  const { count } = useSelector((state:any) => state.datasheet);
 ...
 const pageSize = 5; 
  ...
  useEffect(() => {
    dispatch(fetchDataSheet(page + 1));
    ...
    <Fragment>
      ...
      <Modal isOpen={modalEditOpen} toggle={toggleEdit} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody className='z-2'>
          <DataSheetEditModal rowData={selectedRowData} toggleEdit={toggleEdit} />
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalAddOpen} toggle={toggleAdd} centered tabIndex={-1}>
        ...
        <ModalBody>
          <div>
            <DataSheetAddModal toggleAdd={toggleAdd} pageZero={pageZero}/>
          </div>
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalViewOpen} toggle={toggleView} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody style={{ minHeight: '500px' }}>
          <DataSheetViewModal rowId={selectedRowId}/>
        </ModalBody>
        <ModalFooter>
