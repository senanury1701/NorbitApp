...
import DriveEditModal from '../Drive/DriveEditModal'; 
import DriveAddModal from '../Drive/DriveAddModal';
import DriveViewModal from '../Drive/DriveViewModal';
import { useAppDispatch } from '../hooks';
import { deleteDrive } from '../../slices/drive/thunks';
...
const DriveTable = ({
  ...
  const { count } = useSelector((state:any) => state.drive);
    ...
    <Fragment>
      ...
      <Modal isOpen={modalEditOpen} toggle={toggleEdit} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody className='z-2'>
          <DriveEditModal rowData={selectedRowData} toggleEdit={toggleEdit} />
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalAddOpen} toggle={toggleAdd} centered tabIndex={-1}>
        ...
        <ModalBody>
          <div>
            <DriveAddModal toggleAdd={toggleAdd} pageZero={pageZero}/>
          </div>
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalViewOpen} toggle={toggleView} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody style={{ minHeight: '500px' }}>
          <DriveViewModal rowId={selectedRowId}/>
        </ModalBody>
        <ModalFooter>
