...
const EmployeeManangementTable = ({
  ...
  const { count } = useSelector((state:any) => state.employeeManangement);
 ...
 const pageSize = 5; 
  ...
  const onClickDelete = (id: any) => {
    dispatch(deleteEmployeeManangement(id));
    setPage(0)
  };
    ...
    <Fragment>
      ...
      <Modal isOpen={modalEditOpen} toggle={toggleEdit} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody className='z-2'>
          <EmployeeManangementEditModal rowData={selectedRowData} toggleEdit={toggleEdit} />
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalViewOpen} toggle={toggleView} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody style={{ minHeight: '500px' }}>
          <EmployeeManangementViewModal rowId={selectedRowId}/>
        </ModalBody>
        <ModalFooter>
...
export default EmployeeManangementTable;
