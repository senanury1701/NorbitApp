...
import { fetchKnowhow } from '../../slices/thunks';
...
import KnowhowEditModal from '../Knowhow/KnowhowEditModal'; 
import KnowhowAddModal from '../Knowhow/KnowhowAddModal';
import KnowhowViewModal from '../Knowhow/KnowhowViewModal';
import { useAppDispatch } from '../hooks';
import { deleteKnowhow } from '../../slices/knowhow/thunks';
...
const KnowhowTable = ({
  ...
  const { count } = useSelector((state:any) => state.knowhow);
 ...
 const pageSize = 5; 
  ...
  useEffect(() => {
    dispatch(fetchKnowhow(page + 1, search));
    ...
    <Fragment>
      ...
      <Modal isOpen={modalEditOpen} toggle={toggleEdit} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody className='z-2'>
          <KnowhowEditModal rowData={selectedRowData} toggleEdit={toggleEdit} />
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalAddOpen} toggle={toggleAdd} centered tabIndex={-1}>
        ...
        <ModalBody>
          <div>
            <KnowhowAddModal toggleAdd={toggleAdd} pageZero={pageZero}/>
          </div>
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalViewOpen} toggle={toggleView} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody style={{ minHeight: '500px' }}>
          <KnowhowViewModal rowId={selectedRowId}/>
        </ModalBody>
        <ModalFooter>
