...
import PurchaseViewModal from '../Purchase/PurchaseViewModal';
import { useAppDispatch } from '../hooks';
import { deletePurchase } from '../../slices/purchase/thunks';
...
const PurchaseTable = ({
  ...
  const { count } = useSelector((state:any) => state.purchase);
 ...
 const pageSize = 5; 
  ...
  useEffect(() => {
    dispatch(fetchPurchase(page + 1, search));
    ...
    <Fragment>
      ...
      <Modal isOpen={modalEditOpen} toggle={toggleEdit} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody className='z-2'>
          <PurchaseEditModal rowData={selectedRowData} toggleEdit={toggleEdit} />
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalViewOpen} toggle={toggleView} modalClassName="zoomIn" centered tabIndex={-1}>
        ...
        <ModalBody style={{ minHeight: '500px' }}>
          <PurchaseViewModal rowId={selectedRowId}/>
        </ModalBody>
        <ModalFooter>
